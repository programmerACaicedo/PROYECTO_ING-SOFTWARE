...
public interface IAvisosService {
    ...
    public AvisosModel actualizarEstadoReporteSiendoAdministrador(ObjectId id, ReporteAviso reporte); //Este put es para un administrador que desea actualizar el estado del reporte de un aviso
